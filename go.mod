module github.com/air-iot/api-client-gojs/v4

go 1.25.0

require (
	github.com/air-iot/api-client-go/v4 v4.8.28
...
require (
	...
	github.com/air-iot/json v0.0.4 // indirect
	github.com/air-iot/logger v1.0.15 // indirect
...
replace github.com/glebarez/sqlite => github.com/zhgqiang/sqlite v1.11.0-3

replace github.com/air-iot/service/v4 => git.airiot.tech/core/service/v4 v4.4.246
